...
const SHOTS = [
  ...
  // ── door number plates ──────────────────────────────────────────────────
  ['plate-401', AX(1.0), AZ(4.6), at(-1.0, 1.1), 3 * ST, 0.15],
  ['plate-401-near', AX(0.7), AZ(3.9), at(-0.68, 0.4), 3 * ST, 0.10],
  ['plate-102', AX(1.5), AZ(4.4), at(0.9, 0.9), 0, 0.15],
  ['plate-302-ajar', AX(1.4), AZ(4.4), at(1.0, 0.9), 2 * ST, 0.10],
