// Is every person indoors drawn from the 8-angle atlas?
//
...
const r = await p.evaluate(() => {
  ...
  window.__ct.scene().traverse((o) => {
    ...
    if (w.x < 400) return;                                   // interiors only
