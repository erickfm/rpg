...
console.log(await p.evaluate(()=>{
 ...
 for(const [name,dx,dz] of [['GOLDEN ACES (casino)',51.29,-96],['LIBRARY',null,null],['ST BRIGID (church)',9.6,-79.5],['HOTEL ORPHEUS',null,null]]){
  ...
  const h=hosts[0];
  const id={'GOLDEN':'casino','LIBRARY':'library','ST':'church','HOTEL':'hotel'}[name.split(' ')[0]];
