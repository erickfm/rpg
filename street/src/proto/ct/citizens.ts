  ...
  return pixTex(FW * 5, FH * 2, (g) => {
    for (let view = 0; view < 5; view++) {
      for (let frame = 0; frame < 2; frame++) {
        ...
        // torso, that hid the new lap: jacket runs from row 21 to `armBot` and
        // the hand three rows past that, at cx±(tw…tw+3) — the exact texels a
        // thigh has to protrude through. Standing, that is right. Seated at a
        ...
        // a desk, a counter or a pew rail.
